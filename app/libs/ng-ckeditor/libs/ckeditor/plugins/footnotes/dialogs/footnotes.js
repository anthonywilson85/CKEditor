            ...
            contents: [
                {
                    ...
                    elements: [
                        ...
                        },
                        {
                            ...
                            id: 'footnote_id',
                            name: 'footnote_id',
                            label: 'No existing source marking',
                            ...
                            setup: function( element ) {
                                ...
                                if ($footnotes.length > 0) {
                                    if ($el.find('p').length == 0) {
                                        $el.append('<p style="margin-bottom: 10px;"><strong>OR:</strong> Choose existing source marking:</p><ol class="footnotes_list"></ol>');
                                    } else {
                                        $el.find('ol').empty();
                                    }
