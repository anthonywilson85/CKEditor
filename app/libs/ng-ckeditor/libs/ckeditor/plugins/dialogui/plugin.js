...
CKEDITOR.plugins.add( 'dialogui', {
	onLoad: function() {
		...
		CKEDITOR.tools.extend( CKEDITOR.ui.dialog, {
			...
			/**
			 * A date type with a label.
			 *
			 * @param {Array} htmlList List of HTML code to output to.
			 */
			date: function( dialog, elementDefinition, htmlList ) {
				if ( arguments.length < 3 )
					return;
		...
		/** @class CKEDITOR.ui.dialog.date */
		CKEDITOR.ui.dialog.date.prototype = CKEDITOR.tools.extend( new CKEDITOR.ui.dialog.labeledElement(), {
			/**
			 * Gets the text input DOM element under this UI object.
			 *
			 * @returns {CKEDITOR.dom.element} The DOM element of the text input.
		...
		CKEDITOR.dialog.addUIElement( 'date', commonBuilder );
	}
} );
